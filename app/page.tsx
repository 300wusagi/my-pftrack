                        ...
                        <tr key={h.id} className="hover:bg-gray-50">
                          ...
                          {settings.visibleCols.includes('value') && (
                            <td className="p-4 text-right font-bold text-gray-600">
                              {currentValBase
                                ? currentValBase.toLocaleString(undefined, {
                                    maximumFractionDigits: 2,
                                  })
                                : '-'}
                            </td>
        ...
        {activeTab === 'timeline' && (
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-xl shadow-sm border">
              ...
              <div className="h-80">
                {snapshots.length < 2 ? (
                  <div className="h-full flex items-center justify-center text-gray-400 bg-gray-50 rounded-lg border border-dashed font-bold">
                    需要至少两天的记录才能绘制折线图，系统会在每天自动记录快照。
                  </div>
                ) : (
                  <ResponsiveContainer width="100%" height="100%">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border">
              ...
              <div className="flex gap-2 mb-6">
                ...
                <button
                  ...
                  className="bg-blue-100 text-blue-700 px-4 rounded-lg text-sm font-bold"
                >
                  新建组
                </button>
              </div>
            ...
            <form onSubmit={handleCashSubmit} className="p-5 space-y-4">
              <div className="flex bg-gray-100 p-1 rounded-lg">
                <button
                  ...
                  className={`flex-1 py-1.5 text-sm font-bold rounded-md ${
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden animate-fade-in">
            ...
            >
                ...
                <div>
                  ...
                  <div className="flex gap-1">
                    <input
                      ...
                      step="0.01"
                      required
                      className="w-full border rounded-lg p-2 outline-none flex-1 min-w-0"
                    ...
                    />
                    <select
                      className="border rounded-lg px-1 bg-gray-50 text-xs"
                      value={tradeForm.currency}
                      onChange={(e) =>
                        setTradeForm({ ...tradeForm, currency: e.target.value })
                      }
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      step="0.01"
                      required
                      className="w-full border border-yellow-300 bg-yellow-50 rounded-lg p-2 outline-none flex-1"
                    ...
                    />
                    <select
                      className="border border-yellow-300 rounded-lg p-2 bg-yellow-50"
              ...
              <div className="pt-4 flex gap-3">
                ...
                <button
                  type="submit"
                  className="flex-1 bg-blue-600 text-white py-2 rounded-lg font-bold shadow-md"
                >
                  确认修改
                </button>
              </div>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm overflow-hidden animate-fade-in">
            ...
            <form onSubmit={handleSellSubmit} className="p-5 space-y-4">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    step="0.0001"
                    required
                    className="w-full border rounded-lg p-2 outline-none flex-1"
                    value={tradeForm.quantity}
                    onChange={(e) =>
                      setTradeForm({ ...tradeForm, quantity: e.target.value })
                    }
                  ...
                  <button
                    ...
                    className="bg-gray-100 px-3 rounded-lg text-xs font-bold text-gray-600"
                  >
                    全仓
                  </button>
                </div>
              ...
              <button
                type="submit"
                className="w-full py-2.5 rounded-lg font-bold text-white shadow-sm bg-red-600 hover:bg-red-700 mt-2"
              >
                确认卖出 (资金将转入现金)
              </button>
            </form>
                  ...
                  {tradeForm.trackType === 'auto' ? (
                    <div>
                      ...
                      <input
                        ...
                        required
                        placeholder="如 NVDA"
                        className="w-full border rounded-lg p-2 uppercase outline-none"
